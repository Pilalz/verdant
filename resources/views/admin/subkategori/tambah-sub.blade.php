    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2" style="color: #423118; text-align: center;">Tambah Sub Kategori</h1>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.subkategori.save') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="nama_sub" class="form-label">Nama Sub Kategori</label>
                                <input type="text" class="form-control" id="nama_sub" name="nama_sub" placeholder="Masukkan Nama Kategori">
                            </div>
