        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <h1 class="h3 mt-4" style="color: #423118; text-align: center;">Sub Kategori</h1>

                    <div class="card-body">
                        <a href="{{ route('admin.subkategori.create') }}" class="btn btn-outline-primary">Tambah data</a>
                                ...
                                <tbody>
                                    @forelse ($subkategori as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->id }}</td>
                                            <td>{{ $item->nama_sub }}</td>
                                            <td>{{ $item->kategori }} ({{ $item->nama_kategori }})</td>
                                            <td style="text-align: center;">
                                                <a href="#" onclick="confirmDelete({{ $item->id }})" class="btn btn-outline-danger">Hapus</a>
                                                <a href="{{ route('admin.subkategori.edit', $item->id) }}" class="btn btn-outline-success">Edit</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <div class="alert alert-danger">
            ...
            function confirmDelete(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = `{{ route('admin.subkategori.remove', $item->id) }}`;
                    }
                })
            }
        </script>
