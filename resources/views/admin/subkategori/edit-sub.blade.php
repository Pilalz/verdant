    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2" style="color: #423118; text-align: center;">Edit Sub Kategori</h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.subkategori.update', $post->id) }}" method="POST">
                            @csrf
                            @method('PUT')

                            <div class="form-group">
                                <label class="font-weight-bold">Nama Sub Kategori</label>
                                <input type="text" class="form-control @error('nama_sub') is-invalid @enderror"
                                    name="nama_sub" value="{{ old('nama_sub', $post->nama_sub) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('kategori') is-invalid @enderror" name="kategori">
                                    <option value="{{ old('kategori', $post->kategori) }}">{{ old('kategori', $post->kategori) }} ({{ old('nama_kategori', $post->nama_kategori) }})</option>
