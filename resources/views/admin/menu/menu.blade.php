        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <h1 class="h3 mt-4" style="color: #423118; text-align: center;">Menu</h1>

                    <div class="card-body">
                        <a href="{{ route('admin.menu.create') }}" class="btn btn-outline-primary">Tambah data</a>
                                ...
                                <tbody>
                                    @forelse ($menu as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->id }}</td>
                                            <td><img src="/image/{{ $item->gambar_menu }}" style="width: 200px;"
                                                    alt="">{{ $item->gambar_menu }}
                                            </td>
                                            <td>{{ $item->judul_menu }}</td>
                                            <td>{{ $item->deskripsi_menu }}</td>
                                            <td>{{ $item->harga_menu }}</td>
                                            <td>{{ $item->kategori_menu }} - {{ $item->nama_kategori }} ({{ $item->nama_sub }})</td>
                                            <td style="text-align: center;">
                                                <a href="#" onclick="confirmDelete({{ $item->id }})" class="btn btn-outline-danger">Hapus</a>
                                                <a href="{{ route('admin.menu.edit', $item->id) }}" class="btn btn-outline-success">Edit</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <div class="alert alert-danger">
            ...
            function confirmDelete(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = `{{ route('admin.menu.remove', $item->id) }}`;
                    }
                })
            }
        </script>
