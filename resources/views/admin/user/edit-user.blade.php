    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2" style="color: #423118; text-align: center;">Edit User</h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.user.update', $post->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    name="nama" value="{{ old('nama', $post->nama) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror"
                                    name="password" id="password" value="{{ old('password', $post->password) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror"
                                    name="password_confirmation" id="password_confirmation" value="{{ old('password', $post->password) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="role" name="role">
                                    <option value="{{ old('role', $post->role) }}">{{ old('role', $post->role) }}</option>
