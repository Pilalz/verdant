        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <h1 class="h3 mt-4" style="color: #423118; text-align: center;">Meja</h1>

                    <div class="card-body">
                        <a href="{{ route('admin.meja.create') }}" class="btn btn-outline-primary">Tambah data</a>
                                    ...
                                    @forelse ($meja as $item)
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <a href="{{ route('admin.meja.edit', $item->id) }}" class="btn btn-outline-success">Ubah</a>
                                            </td>
                                        </tr>
                                    @empty
            ...
            function confirmDelete(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = `{{ route('admin.meja.remove', $item->id) }}`;
                    }
                })
            }
        </script>
