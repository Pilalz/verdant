    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2" style="color: #423118; text-align: center;">Edit Meja</h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.meja.update', $post->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('no_meja') is-invalid @enderror"
                                    name="no_meja" value="{{ old('no_meja', $post->no_meja) }}"
