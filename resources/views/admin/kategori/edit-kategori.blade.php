    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2" style="color: #423118; text-align: center;">Edit Kategori</h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.kategori.update', $post->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_kategori') is-invalid @enderror"
                                    name="nama_kategori" value="{{ old('nama_kategori', $post->nama_kategori) }}"
