        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <h1 class="h3 mt-4" style="color: #423118; text-align: center;">Kategori</h1>

                    <div class="card-body">
                        <a href="{{ route('admin.kategori.create') }}" class="btn btn-outline-primary">Tambah data</a>
                                    ...
                                    @forelse ($kategori as $item)
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <a href="{{ route('admin.kategori.edit', $item->id) }}" class="btn btn-outline-success">Ubah</a>
                                            </td>
                                        </tr>
                                    @empty
            ...
            function confirmDelete(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = `{{ route('admin.kategori.remove', $item->id) }}`;
                    }
                })
            }
        </script>
