                            ...
                            <div class="table-responsive">
                                    <table class="mb-4">
                                        ...
                                        <tr>
                                            <th>Nomor Meja </th>
                                            <td> : </td>
                                            <td>{{ $detail_transaksi->no_meja }}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>Kasir </th>
                                            <td> : </td>
                                            <td>{{ $detail_transaksi->id_kasir }}</td>
                                        </tr>
                                    </table>
                                    ...
                                    <table>
                                        <tr>
                                            <th>Total Menu</th>
                                            <td> : </td>
                                            <td>{{ $detail_transaksi->total_menu }}</td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>Dibayar</th>
                                            <td> : </td>
                                            <td>RP. {{ number_format($detail_transaksi->dibayar, 0, ',', '.') }}</td>
                                        </tr>
                                    
                                        <tr>
                                            <th>Kembalian</th>
                                            <td> : </td>
                                            <td>RP. {{ number_format($detail_transaksi->kembalian, 0, ',', '.') }}</td>
                                        </tr>
                                    </table>
                                    <a href="{{ route('admin.pesanan-paid') }}" class="btn btn-dark mt-4">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
