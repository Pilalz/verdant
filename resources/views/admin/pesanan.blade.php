...
@section('isinya')
    ...
    <style>
        /* Di file CSS Anda, misalnya app.css atau style.css */
        .active-card {
            background-color: #28a745; /* Warna latar belakang yang berbeda untuk tombol aktif */
            color: white; /* Mengubah teks menjadi putih */
        }

        .active-card .h5, .active-card .fa-dollar-sign {
            color: white; /* Mengubah warna teks dan ikon menjadi putih */
        }
    </style>
    <!-- Content Wrapper -->
                                    ...
                                    @forelse ($transaksi as $item)
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a href="{{ route('admin.pesanan.detail', $item->id) }}" class="btn btn-outline-primary">Detail</a>
